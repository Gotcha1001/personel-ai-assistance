...
//   delay: number;
//   expiry: number;
//   layerVariation: boolean;
//   triangleTypes: TriangleType[];
//   zIndex: number;
// }

// // Triangle type options
// type TriangleType = "standard" | "elongated" | "equilateral" | "inverted";

// const TriangleMandalas2: React.FC = () => {
...
//   const generateMandalaShapes = (count: number) => {
//     const newMandalas: MandalaShape[] = Array(count)
//       .fill(0)
//       .map((_, i) => {
...
//         const availableTypes: TriangleType[] = [
//           "standard",
//           "elongated",
//           "equilateral",
//           "inverted",
...
//   const getTrianglePoints = (type: TriangleType): string => {
//     switch (type) {
//       case "standard":
...
const TriangleMandalas2: React.FC = () => {
  ...
  const checkOverlap = (
    mandala1: Partial<MandalaShape>,
    mandala2: Partial<MandalaShape>
  ): boolean => {
    if (
      !mandala1.centerX ||
      !mandala1.centerY ||
  ...
  const findNonOverlappingPosition = (
    existingMandalas: MandalaShape[],
    newMandala: Partial<MandalaShape>,
  ...
  const generateMandalaShapes = (count: number) => {
    ...
    const newMandalas: MandalaShape[] = [];
    ...
    for (let i = 0; i < count; i++) {
      ...
      const partialMandala: Partial<MandalaShape> = { size };
